<template>
  <div class="grid grid-cols-6 gap-4 -top-32">
    <div class="bg-white col-start-2 col-span-4 p-32 my-32 rounded-lg border border-solid border-red-100">
        ...
        >
          <h1 class="text-4xl text-center" style="font-family: tinos;">I was wrong about macOS Big Sur...</h1>
        </highlightable-menu>
        <highlightable-menu
          @share="onShare"
          @highlight="onHighlight"
...
<script>
import HighlightableMenu from '@/components/HighlightableMenu'
export default {
  name: 'Article',
  components: {
    "highlightable-menu": HighlightableMenu,
  },
  data() {
    return {
      isTooltipOpen: false,
